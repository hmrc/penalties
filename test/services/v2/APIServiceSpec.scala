...
import models.v3.getPenaltyDetails.lateSubmission.{LSPDetails, LSPPenaltyCategoryEnum, LSPPenaltyStatusEnum, LSPSummary, LateSubmissionPenalty}
...
class APIServiceSpec extends SpecBase {
  ...
  "findEstimatedPenaltiesAmount" should {
    ...
    "return the outstanding amount of LPPs" in new Setup {
      ...
      result shouldBe BigDecimal(20.42)
    }
