...
class UserHasPenaltyAuditModelSpec extends SpecBase with LogCapturing {
  ...
  val basicModel: UserHasPenaltyAuditModel =
    UserHasPenaltyAuditModel(basicGetPenaltyDetailsModel, "1234", "VRN", None, mockDateHelper)(
      fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val basicAgentModel: UserHasPenaltyAuditModel =
    UserHasPenaltyAuditModel(basicGetPenaltyDetailsModel, "1234", "VRN", Some("ARN123"), mockDateHelper)(
      fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithInterest: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithVATDue, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLSPPs: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLSPPs, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithPartiallyPaidLSPs: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithPartiallyPaidLSPs, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithActiveAndInactiveLSPPs: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithActiveAndInactiveLSPPs, "1234", "VRN", None)(
      fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLSPPsUnderReview: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLSPPsUnderAppeal, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLSPPsAppealed: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLSPPsAppealed, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLSPUnpaidAndPaid: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLSPUnpaidAndRemoved, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsPaid: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsPaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsUnpaid: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsUnpaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsPartiallyPaid: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsPartiallyPaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsUnderReview: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsUnderReview, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsAccepted: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsAccepted, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid: UserHasPenaltyAuditModel =
    basicModel.copy(getPenaltyDetailsModelWithLPPsPaidAndUnpaidAndPartiallyPaid, "1234", "VRN", None)(
      fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithManualLPPPaid =
    basicModel.copy(getPenaltyDetailsModelManualLPPPaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithManualLPPPartiallyPaid =
    basicModel.copy(getPenaltyDetailsModelManualLPPPartiallyPaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val auditModelWithManualLPPUnpaid =
    basicModel.copy(getPenaltyDetailsModelManualLPPUnpaid, "1234", "VRN", None)(fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))

  val basicModelWithUserAgent: String => UserHasPenaltyAuditModel =
    (userAgent: String) =>
      UserHasPenaltyAuditModel(basicGetPenaltyDetailsModel, "1234", "VRN", None, mockDateHelper)(fakeRequest.withHeaders("User-Agent" -> userAgent))
  ...
  "UserHasPenaltyAuditModel" should {
    ...
    "show the correct audit details" when {
      ...
      "the user has LSPPs (with appeals)" in {
        (auditModelWithLSPPsUnderReview.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "penaltyPointsThreshold")
          .validate[Int]
          .get shouldBe 5
        ...
        (auditModelWithLSPPsUnderReview.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "financialPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLPPsUnderReview.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        ...
        (auditModelWithLSPPsUnderReview.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPartiallyPaidLSPs")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLSPPsUnderReview.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
      }

      "the user has LSPPs (with reviewed appeals)" in {
        (auditModelWithLSPPsAppealed.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "penaltyPointsThreshold")
          .validate[Int]
          .get shouldBe 5
        ...
        (auditModelWithLSPPsAppealed.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "financialPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLSPPsAppealed.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        ...
        (auditModelWithLSPPsAppealed.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPartiallyPaidLSPs")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLSPPsAppealed.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
      }

      "the user has LSPs that are paid and unpaid" in {
        (auditModelWithLSPUnpaidAndPaid.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "penaltyPointsThreshold")
          .validate[Int]
          .get shouldBe 2
        ...
        (auditModelWithLSPUnpaidAndPaid.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "financialPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithLSPUnpaidAndPaid.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        ...
        (auditModelWithLSPUnpaidAndPaid.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPartiallyPaidLSPs")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLSPUnpaidAndPaid.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 1
      }

      "the user has LSPs  that are partially paid" in {
        (auditModelWithPartiallyPaidLSPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "penaltyPointsThreshold")
          .validate[Int]
          .get shouldBe 5
        ...
        (auditModelWithPartiallyPaidLSPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "financialPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithPartiallyPaidLSPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        ...
        (auditModelWithPartiallyPaidLSPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfPartiallyPaidLSPs")
          .validate[Int]
          .get shouldBe 1
      }
      ...
      "the user has LSPs" in {
        ...
        (auditModelWithInterest.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 2
      }

      "the user has inactive LSPs" in {
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "penaltyPointsThreshold")
          .validate[Int]
          .get shouldBe 5
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "pointsTotal")
          .validate[Int]
          .get shouldBe 2
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "inactivePoints")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "financialPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "underAppeal")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithActiveAndInactiveLSPPs.detail \ "penaltyInformation" \ "lateSubmissionPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
      }
      ...
      "the user has LPPs (all partially paid)" in {
        (auditModelWithLPPsPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLPPsPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLPPsPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPartiallyPaidPenalties")
          .validate[Int]
          .get shouldBe 2
        (auditModelWithLPPsPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 3
      ...
      "the user has a manual LPP - paid" in {
        (auditModelWithManualLPPPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithManualLPPPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithManualLPPPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 1
      ...
      "the user has a manual LPP - partially paid" in {
        (auditModelWithManualLPPPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithManualLPPPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithManualLPPPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPartiallyPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithManualLPPPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 1
      ...
      "the user has a manual LPP - unpaid" in {
        (auditModelWithManualLPPUnpaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithManualLPPUnpaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithManualLPPUnpaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPartiallyPaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithManualLPPUnpaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 1
      ...
      "the user has a combination of unpaid and paid and partially paid LPPs" in {
        (auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPartiallyPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 3
        (auditModelWithLPPsUnpaidAndPaidAndPartiallyPaid.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "underAppeal")
          .validate[Int]
          .get shouldBe 0
      ...
      "the user has LPPs (with appeals)" in {
        (auditModelWithLPPsUnderReview.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfPaidPenalties")
          .validate[Int]
          .get shouldBe 1
        (auditModelWithLPPsUnderReview.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLPPsUnderReview.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 2
      ...
      "the user has LPPs (with reviewed appeals)" in {
        ...
        (auditModelWithLPPsAccepted.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "numberOfUnpaidPenalties")
          .validate[Int]
          .get shouldBe 0
        (auditModelWithLPPsAccepted.detail \ "penaltyInformation" \ "latePaymentPenaltyDetail" \ "totalNumberOfPenalties")
          .validate[Int]
          .get shouldBe 1
      ...
      "the user has an active TTP - With end date" in {
        ...
        (auditModelWithLPPsUnpaid.detail \ "penaltyInformation" \ "timeToPayInformation" \ "timeToPayStartDate")
          .validate[LocalDate]
          .get shouldBe LocalDate.of(2022, 1, 1)
        (auditModelWithLPPsUnpaid.detail \ "penaltyInformation" \ "timeToPayInformation" \ "timeToPayEndDate")
          .validate[LocalDate]
          .get shouldBe LocalDate.of(2022, 12, 31)
      }

      "the user has an active TTP - With no end date" in {
        when(mockDateHelper.dateNow()).thenReturn(LocalDate.of(2022, 2, 1))
        val auditModelWithLPPsUnpaid: UserHasPenaltyAuditModel =
          basicModel.copy(getPenaltyDetailsModelWithLPPsUnpaidNoTTPEndDate, "1234", "VRN", None)(
            fakeRequest.withHeaders("User-Agent" -> "penalties-frontend"))
        (auditModelWithLPPsUnpaid.detail \ "penaltyInformation" \ "timeToPayInformation" \ "isTimeToPayActive").validate[Boolean].get shouldBe true
        (auditModelWithLPPsUnpaid.detail \ "penaltyInformation" \ "timeToPayInformation" \ "timeToPayStartDate")
          .validate[LocalDate]
    ...
    "set the callingService to service name and log error when the User-Agent can not be matched" in {
      withCaptureOfLoggingFrom(Logger.logger) { logs =>
        (basicModelWithUserAgent("rogue-service").detail \ "callingService").validate[String].get shouldBe "rogue-service"
        logs.exists(
          _.getMessage.equals("[UserHasPenaltyAuditModel] - unknown caller has been identified retrieving summary data: rogue-service")) shouldBe true
      }
    }
    ...
    "set the callingService to blank and log error when the User-Agent is not provided" in {
      withCaptureOfLoggingFrom(Logger.logger) { logs =>
        ...
        logs.exists(
          _.getMessage.equals("[UserHasPenaltyAuditModel] - could not distinguish referer for audit - setting value to blank")) shouldBe true
      }
    }
  }
}
