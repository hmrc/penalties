...
class AppealStatusEnumSpec extends SpecBase {
  ...
  "AppealStatusEnum" should {
    ...
    readableTest("CHARGE ALREADY REVERSED - Appeal Rejection", "91", AppealStatusEnum.AppealUpheldChargeAlreadyReversed)
    readableTest("POINT ALREADY REMOVED - Appeal Upheld", "92", AppealStatusEnum.AppealCancelledPointAlreadyRemoved)
    readableTest("CHARGE ALREADY REVERSED - Appeal Upheld", "93", AppealStatusEnum.AppealCancelledChargeAlreadyReversed)
    readableTest("POINT ALREADY REMOVED - Appeal Rejection", "94", AppealStatusEnum.AppealUpheldPointAlreadyRemoved)
