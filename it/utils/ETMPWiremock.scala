...
trait ETMPWiremock extends WiremockHelper{
  ...
  val getFinancialDetailsHipResponseWithoutTotalisations: JsValue = Json.parse(
    """
      |{
      | "success": {
  ...
  val getFinancialDetailsIFAsJson: JsValue = Json.parse(
    """
      |{
      | "getFinancialData": {
      |   "financialDetails":{
  ...
  val getFinancialDetailsHIPAsJson: JsValue = Json.parse(
    """
      |{
      | "success": {
