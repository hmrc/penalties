...
class PenaltiesFrontendControllerISpec extends IntegrationSpecCommonBase with ETMPWiremock with AuthTestHelper {
  ...
  "getPenaltiesData" when {
    ...
    testAuthorisationOnEndpoint("/etmp/penalties/HMRC-MTD-VAT~VRN~123456789")
  }
}
