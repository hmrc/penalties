...
class ComplianceControllerISpec extends IntegrationSpecCommonBase with ComplianceWiremock with FeatureSwitching with AuthTestHelper {
  ...
  "getComplianceData" when {
    ...
    testAuthorisationOnEndpoint("/compliance/des/compliance-data?vrn=123456789&fromDate=2020-01-31&toDate=2020-12-31")
  }
}
