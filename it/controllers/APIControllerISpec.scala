...
class APIControllerISpec extends IntegrationSpecCommonBase with ETMPWiremock with FeatureSwitching with AuthTestHelper {
  val controller: APIController = injector.instanceOf[APIController]

  "getSummaryDataForVRN" when {
    ...
    testAuthorisationOnEndpoint("/vat/penalties/summary/123456789")
  }
  ...
  "getFinancialDetails" when {
    ...
    testAuthorisationOnEndpoint("/penalty/financial-data/VRN/123456789/VATC?searchType=CHGREF&searchItem=XC00178236592&dateType=BILLING&dateFrom=2020-10-03&dateTo=2021-07-12&includeClearedItems=false" +
      s"&includeStatisticalItems=true&includePaymentOnAccount=true&addRegimeTotalisation=false&addLockInformation=true&addPenaltyDetails=true" +
      s"&addPostedInterestDetails=true&addAccruingInterestDetails=true")
  }

  "getPenaltyDetails" when {
    ...
    testAuthorisationOnEndpoint("/penalty-details/VAT/VRN/123456789?dateLimit=09")
  }
}
