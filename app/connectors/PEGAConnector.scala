...
class PEGAConnector @Inject()(httpClient: HttpClient,
  ...
  def submitAppeal(appealSubmission: AppealSubmission, enrolmentKey: String,
                   isLPP: Boolean, penaltyNumber: String, correlationId: String): Future[AppealSubmissionResponse] = {
    ...
    httpClient.POST[AppealSubmission, AppealSubmissionResponse](
      appConfig.getAppealSubmissionURL(enrolmentKey, isLPP, penaltyNumber), appealSubmission, hc.otherHeaders)
  }
