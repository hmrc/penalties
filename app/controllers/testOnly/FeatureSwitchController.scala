...
import featureSwitches.{FeatureSwitch, FeatureSwitching}
import play.api.mvc.{Action, AnyContent, ControllerComponents, Result}
import uk.gov.hmrc.play.bootstrap.backend.controller.BackendController

import javax.inject.Inject

class FeatureSwitchController @Inject()(implicit cc: ControllerComponents) extends BackendController(cc) with FeatureSwitching {
